...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      {/* Right side */}
      <div className="hidden lg:flex items-center justify-center p-6 sm:p-12">
        <AuthImagePattern
          title="Get Salty with Friends"
          subtitle="Join the community and start sharing your salty moments with friends and family."
        />
      </div>
    </div>
  );
